defmodule TopDeckTutorWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TopDeckTutorWeb.Gettext
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        "flex w-80 max-w-80 items-start gap-3 rounded-lg px-4 py-3 text-sm sm:w-96 sm:max-w-96",
        @kind == :info && "app-flash-success",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TopDeckTutorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TopDeckTutorWeb.Gettext, "errors", msg, opts)
    end
  end
